...
inserirVersículo('1 Rs 15.28', 'Baasa matou Nadabe no terceiro ano do reinado de Asa, rei de Judá, e foi o seu sucessor.', () => {
  expressão([expressão('Baasa matou Nadabe'), ...tokens('no terceiro ano do reinado de Asa')]);
...
inserirVersículo(
  ...
  () => {
    expressão([expressão('Baasa matou toda a família de Jeroboão'), ...tokens('assim que começou a reinar')]);
    expressão([
      expressão('Baasa não deixou ninguém vivo dos pertencentes a Jeroboão, mas destruiu a todos'),
