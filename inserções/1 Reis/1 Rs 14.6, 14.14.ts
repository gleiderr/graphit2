...
inserirVersículo(
  ...
  () => {
    a = expressão(
      'Quando Aías ouviu o som dos passos da mulher de Jeroboão junto da porta, ele disse: ',
    );
...
inserirVersículo(
  ...
  () => {
    expressão([
      a,
      ...tokens(
        '"O Senhor levantará para si um rei sobre Israel (Baasa) que eliminará a família de Jeroboão." ',
      ),
    ]);
